...
namespace BPMeAUChatBot.API.Tests.ServicesUnitTest.cs
{
    public class DecryptionServiceUnitTest
    {
        ...
        public void Test_Encrypt_IsSucess()
        {
            ...
            var mockConfigurationEncKey = new Mock<IConfigurationSection>();
            mockConfigurationEncKey.Setup(x => x.Value).Returns("SampleEncryptionKey");
            configuration.Setup(x => x.GetSection("EncryptionKey")).Returns(mockConfigurationEncKey.Object);
            ...
            //Act
            var service = new EncryptionService(configuration.Object, mockLogger);
        ...
        public void TestEncription()
        {
            ...
            var encryptionService = new EncryptionService(configuration.Object, mockLogger);
